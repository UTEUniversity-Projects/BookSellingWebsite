                    ...
                    <ul class="cr-sb-drop condense">
                        <li class="cr-sb-item sb-subdrop-item">
                            <a href="javascript:void(0)" class="cr-sub-drop-toggle">
                                ...
                                <span class="condense">Tài chính
                                    <i class="drop-arrow ri-arrow-down-s-line"></i>
                                </span>
                            </a>
                            <ul class="cr-sb-subdrop condense">
                                <li>
                                    <a href="${pageContext.request.contextPath}/owner/ecommerce"
                        ...
                        <li class="cr-sb-item sb-subdrop-item">
                            <a href="javascript:void(0)" class="cr-sub-drop-toggle">
                                ...
                                <span class="condense">Sản phẩm
                                    <i class="drop-arrow ri-arrow-down-s-line"></i>
                                </span>
                            </a>
                            <ul class="cr-sb-subdrop condense">
                                <li>
                                    <a href="${pageContext.request.contextPath}/owner/product/list"
                                       class="cr-page-link drop">
                                        <i class="ri-checkbox-blank-circle-line"></i>
                                        Sản phẩm
                                    </a>
                        ...
                        <li class="cr-sb-item sb-subdrop-item">
                            ...
                            <ul class="cr-sb-subdrop condense">
                                <li>
                                    <a href="${pageContext.request.contextPath}/owner/promotion-list"
                                       class="cr-page-link drop"
                                    >
                                        <i class="ri-checkbox-blank-circle-line"></i>
                                ...
                                <li>
                                    <a href="${pageContext.request.contextPath}/owner/add-promotion"
                                       class="cr-page-link drop"
                                    >
                                        <i class="ri-checkbox-blank-circle-line"></i>
                                        Thêm khuyến mãi
                        ...
                        <li class="cr-sb-item sb-subdrop-item">
                            ...
                            <ul class="cr-sb-subdrop condense">
                                <li>
                                    <a href="${pageContext.request.contextPath}/owner/staff/list"
                                       class="cr-page-link subdrop">
                                        <i class="ri-checkbox-blank-circle-line"></i>
                                        Danh sách nhân viên
                                    </a>
                        ...
                        <li class="cr-sb-item sb-subdrop-item">
                            ...
                            <ul class="cr-sb-subdrop condense">
                                <li>
                                    <a href="${pageContext.request.contextPath}/owner/author/list"
                                       class="cr-page-link subdrop">
                                        <i class="ri-checkbox-blank-circle-line"></i>
                                        Tác giả
                                    </a>
                                ...
                                <li>
                                    <a href="${pageContext.request.contextPath}/owner/translator/list"
                                       class="cr-page-link drop">
                                        <i class="ri-checkbox-blank-circle-line"></i>
                                        Dịch giả
                                    </a>
