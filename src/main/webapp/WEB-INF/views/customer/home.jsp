...
<!-- Categories -->
<%--<section class="section-categories padding-b-24">--%>
...
<!-- Popular product -->
<section class="section-popular-product-shape padding-b-24">
                            ...
                            <div class="swiper-slide">
                                <div class="cr-services">
                                    ...
                                    <div class="cr-services-contain">
                                        ...
                                        <p>
                                            Chúng tôi cam kết đóng gói cẩn thận, bảo vệ sản phẩm an toàn trong suốt quá
                                            trình vận chuyển, giúp bạn yên tâm nhận hàng nguyên vẹn.
                                        </p>
                                    </div>
                            ...
                            <div class="swiper-slide">
                                <div class="cr-services">
                                    ...
                                    <div class="cr-services-contain">
                                        <h4>Hỗ Trợ 24/7</h4>
                                        <p>
                                            Chúng tôi luôn sẵn sàng hỗ trợ bạn mọi lúc, mọi nơi, giải đáp mọi thắc mắc
                                            và giúp bạn giải quyết vấn đề nhanh chóng.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="cr-services">
                                    ...
                                    <div class="cr-services-contain">
                                        ...
                                        <p>
                                            Chúng tôi cam kết giao hàng nhanh chóng và đảm bảo sản phẩm sẽ
                                            được chuyển đến tay bạn trong vòng 5 ngày.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="cr-services">
                                    ...
                                    <div class="cr-services-contain">
                                        ...
                                        <p>
                                            Chúng tôi cam kết bảo mật tuyệt đối thông tin thanh toán của khách hàng,
                                            đảm bảo sự an toàn tuyệt đối và cảm giác an tâm.
                                        </p>
                                    </div>
                                </div>
                            </div>
...
<%--                            <div class="cr-product-image">--%>
<%--                                <div class="cr-image-inner zoom-image-hover">--%>
<%--                                    <img src="${pageContext.request.contextPath}/assets/customer/img/product/9.jpg"--%>
<%--                                         alt="product-1"/>--%>
<%--                                </div>--%>
<%--                                <div class="cr-side-view">--%>
...
<%--                            <div class="cr-product-image">--%>
<%--                                <div class="cr-image-inner zoom-image-hover">--%>
<%--                                    <img src="${pageContext.request.contextPath}/assets/customer/img/product/10.jpg"--%>
<%--                                         alt="product-1"/>--%>
<%--                                </div>--%>
<%--                                <div class="cr-side-view">--%>
<%--                                    <a href="javascript:void(0)" class="wishlist">--%>
...
<%--                            <div class="cr-product-image">--%>
<%--                                <div class="cr-image-inner zoom-image-hover">--%>
<%--                                    <img src="${pageContext.request.contextPath}/assets/customer/img/product/2.jpg"--%>
<%--                                         alt="product-1"/>--%>
<%--                                </div>--%>
<%--                                <div class="cr-side-view">--%>
<%--                                    <a href="javascript:void(0)" class="wishlist">--%>
...
<%--                            <div class="cr-product-image">--%>
<%--                                <div class="cr-image-inner zoom-image-hover">--%>
<%--                                    <img src="${pageContext.request.contextPath}/assets/customer/img/product/3.jpg"--%>
<%--                                         alt="product-1"/>--%>
<%--                                </div>--%>
<%--                                <div class="cr-side-view">--%>
<%--                                    <a href="javascript:void(0)" class="wishlist">--%>
...
<%--                                    <img src="${pageContext.request.contextPath}/assets/customer/img/blog/2.jpg"--%>
<%--                                         alt="blog-2"/>--%>
...
<%--                                </div>--%>
<%--                                <div class="cr-blog-image">--%>
<%--                                    <img src="${pageContext.request.contextPath}/assets/customer/img/blog/1.jpg"--%>
<%--                                         alt="blog-1"/>--%>
<%--                                    <div class="cr-blog-date">--%>
...
<%--                                </div>--%>
<%--                                <div class="cr-blog-image">--%>
<%--                                    <img src="${pageContext.request.contextPath}/assets/customer/img/blog/3.jpg"--%>
<%--                                         alt="blog-2"/>--%>
<%--                                    <div class="cr-blog-date">--%>
<%--                        <span>--%>
<%--                          12--%>
