          ...
          <div class="col-12">
            <div class="cr-shop-bredekamp">
              ...
              <div class="center-content">
                <span>Chúng tôi đã tìm thấy 29 sản phẩm cho bạn!</span>
              </div>
              <div class="cr-select">
          ...
          <div class="col-xxl-3 col-xl-4 col-6 cr-product-box mb-24">
            <div class="cr-product-card">
              ...
              <div class="cr-product-details">
                ...
                <a href="product" class="title">Fresh organic villa farm lomon
                  500gm pack</a>
          ...
          <div class="col-xxl-3 col-xl-4 col-6 cr-product-box mb-24">
            <div class="cr-product-card">
              ...
              <div class="cr-product-details">
                ...
                <a href="product" class="title">Best snakes with hazel nut pack
                  200gm</a>
                <p class="text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                  eiusmod tempor incididunt
                  ut labore lacus vel facilisis.</p>
          ...
          <div class="col-xxl-3 col-xl-4 col-6 cr-product-box mb-24">
            <div class="cr-product-card">
              ...
              <div class="cr-product-details">
                ...
                <a href="product" class="title">Fresh organic apple 1kg simla
                  marming</a>
                <p class="text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                  eiusmod tempor incididunt
                  ut labore lacus vel facilisis.</p>
          ...
          <div class="col-xxl-3 col-xl-4 col-6 cr-product-box mb-24">
            <div class="cr-product-card">
              ...
              <div class="cr-product-details">
                ...
                <a href="product" class="title">Organic fresh venila farm
                  watermelon 5kg</a>
                <p class="text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                  eiusmod tempor incididunt
                  ut labore lacus vel facilisis.</p>
          ...
          <div class="col-xxl-3 col-xl-4 col-6 cr-product-box mb-24">
            <div class="cr-product-card">
              ...
              <div class="cr-product-details">
                ...
                <a href="product" class="title">Sweet crunchy nut mix 250gm
                  pack</a>
                <p class="text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                  eiusmod tempor incididunt
                  ut labore lacus vel facilisis.</p>
          ...
          <div class="col-xxl-3 col-xl-4 col-6 cr-product-box mb-24">
            <div class="cr-product-card">
              ...
              <div class="cr-product-details">
                ...
                <a href="product" class="title">Delicious white baked fresh bread
                  and toast</a>
                <p class="text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                  eiusmod tempor incididunt
                  ut labore lacus vel facilisis.</p>
