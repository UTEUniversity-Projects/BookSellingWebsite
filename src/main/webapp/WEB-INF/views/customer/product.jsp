          ...
          <div class="banner-slider">
            <div class="slider slider-for">
              <div class="slider-banner-image">
                <div class="zoom-image-hover">
                  <img
                          src="customer/img/product/9.jpg"
                          alt="product-tab-1"
                          class="product-image"
                  />
                </div>
              ...
              <div class="slider-banner-image">
                <div class="zoom-image-hover">
                  <img
                          src="customer/img/product/11.jpg"
                          alt="product-tab-3"
                          class="product-image"
                  />
                </div>
              ...
              <div class="slider-banner-image">
                <div class="zoom-image-hover">
                  <img
                          src="customer/img/product/12.jpg"
                          alt="product-tab-1"
                          class="product-image"
                  />
                </div>
              ...
              <div class="slider-banner-image">
                <div class="zoom-image-hover">
                  <img
                          src="customer/img/product/13.jpg"
                          alt="product-tab-2"
                          class="product-image"
                  />
                </div>
              ...
              <div class="slider-banner-image">
                <div class="zoom-image-hover">
                  <img
                          src="customer/img/product/14.jpg"
                          alt="product-tab-3"
                          class="product-image"
                  />
                </div>
              ...
              <div class="slider-banner-image">
                <div class="zoom-image-hover">
                  <img
                          src="customer/img/product/15.jpg"
                          alt="product-tab-1"
                          class="product-image"
                  />
                </div>
              ...
              <div class="slider-banner-image">
                <div class="zoom-image-hover">
                  <img
                          src="customer/img/product/16.jpg"
                          alt="product-tab-2"
                          class="product-image"
                  />
                </div>
            ...
            <div class="slider slider-nav thumb-image">
              <div class="thumbnail-image">
                <div class="thumbImg">
                  <img src="customer/img/product/9.jpg" alt="product-tab-1" />
                </div>
              </div>
              <div class="thumbnail-image">
                <div class="thumbImg">
            ...
            <div class="author-section">
              ...
              >
                <img
                        src="customer/img/logo/logo.png"
                        alt="Author Image"
                        class="author-image"
                />
          ...
          <div class="tab-content" id="myTabContent">
            ...
            >
              <div class="cr-tab-content-from">
                <div class="post">
                  <div class="content">
                    <img src="customer/img/review/1.jpg" alt="review" />
                    <div class="details">
                  ...
                  <div class="content mt-30">
                    <img src="customer/img/review/2.jpg" alt="review" />
                    <div class="details">
