                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="#" onclick="authorAction(${author.id}, 'view'); return false;">Chi tiết</a>
                                                        <a class="dropdown-item" href="#" onclick="authorAction(${author.id}, 'update'); return false;">Chỉnh sửa</a>
                                                        <a class="dropdown-item" href="#" onclick="authorAction(${author.id}, 'delete'); return false;">Xóa</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
