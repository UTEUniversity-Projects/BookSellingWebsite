            ...
            success: function (data) {
                ...
                if (data.promotionId !== null) {
                    ...
                    if (data.type === 'FREESHIP') {
                        ...
                        promotionData.discountLimit = Math.min(freeshipAmount, promotionData.discountLimit);

                        const freeshipElement = $('#price-freeship');
                        if (promotionData.discountLimit > 0) {
                            ...
                            freeshipElement.text('-0');
                            freeshipElement.attr('data-price', 0);
                        }
                    }
                    ...
                    totalPrice -= Math.min(promotionData.discountLimit, totalPrice);
                    totalPrice = Math.max(totalPrice, 10000);
